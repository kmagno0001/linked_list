...
public:
	...
	const Iterator<T> rbegin( void ) const;
	const Iterator<T> rend( void ) const;
...
template< typename T>
Iterator<T> List<T>::rbegin( void ) {
  	return Iterator{ tail_node };
} 

template< typename T> 
Iterator<T> List<T>::rend( void ) {
  	return Iterator{ head_node->prev_node };
}

template< typename T>
const Iterator<T> List<T>::rbegin( void ) const {
  	return Iterator{ tail_node };
} 

template< typename T> 
const Iterator<T> List<T>::rend( void ) const {
  	return Iterator{ head_node->prev_node };
}
